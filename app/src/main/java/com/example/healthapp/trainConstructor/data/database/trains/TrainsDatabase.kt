package com.example.healthapp.trainConstructor.data.database.trains

import com.example.healthapp.core.data.flowAdapter
import com.example.healthapp.trainConstructor.data.entities.TrainRealm
import com.example.healthapp.trainConstructor.data.mappers.realmMappers.TrainsRealmMapper
...
class TrainsDatabase @Inject constructor(
    private val realmConfiguration: RealmConfiguration,
    private val trainsMapper: TrainsRealmMapper
) {
